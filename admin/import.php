	...
	$filename=$_FILES["filename"]["tmp_name"];
		 if($_FILES["filename"]["size"] > 0){
	         ...
	         while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE){
	         	...
	         	$email = $emapData[3];
	         	$gender = $emapData[4];
	         	$prog_study = $emapData[5];
	         	$year_level = $emapData[6];
	         	// $voted = $emapData[7] ;
	         	// $id_number = $emapData[8];

	           $sql = "INSERT into voters (`id_number`, `firstname`, `lastname`,`gender`,prog_study, `year_level`, `status`,date, password) 
	            	values('$emapData[0]','$emapData[1]','$emapData[2]','$emapData[3]','$emapData[4]','$emapData[5]','Unvoted','$emapData[6]','$emapData[6]')";
